...
NODE_NAME: Final = "vesc_driver_node"
# TOPIC_LEFT: Final = "/vesc_L/duty"  # Float32
# TOPIC_RIGHT: Final = "/vesc_R/duty"  # Float32
TOPIC_LEFT: Final = "commands/dutycycle"  # Float64
TOPIC_RIGHT: Final = "commands/dutycyclecan"  # Float64
DEFAULT_SERIAL_ADDR: Final = "/dev/ttyACM0"
# NEW_SERIAL_ADDR: Final = "/dev/ttyACM1"
...
class VESCDiffDriver(Node):
    def __init__(self):
        ...
        # )
        self.subs_duty_left = self.create_subscription(
            Float64, TOPIC_LEFT, self.set_duty_left, UPDATE_RATE
        )
        self.subs_duty_right = self.create_subscription(
            Float64, TOPIC_RIGHT, self.set_duty_right, UPDATE_RATE
        )
        self.tmr = self.create_timer(0.02 , self.update_vesc_demands)
        self.subs_duty_left
