...
def generate_launch_description():
    ...
    launch_ros.actions.Node(
            ...
            remappings=[('odometry/filtered', 'odometry/global'),
                        #('odometry/gps', '/odometry/gps_corrected')
                        ]
           ),           
    launch_ros.actions.Node(
            package='robot_localization', 
            ...
            remappings=[#('imu/data', 'imu/data'),
                        #('imu', '/bno055/imu'),
                        ('imu', '/bno055/imu/corrected'),
                        #('gps/fix', 'gps/fix'),
                        ('gps/fix', '/ublox_gps_node/fix'),  # Updated topic name
                        #('gps/fix', '/adjusted_fix'), 
    ...
    # launch_ros.actions.Node(
    #         package='matplotlib_plot', 
    #         executable='conversion_gps_data', 
    #         name='conversion_gps_data',
	#         output='screen',           
    #        ),           
])
