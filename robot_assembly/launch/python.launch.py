...
def generate_launch_description():
    ...
    urdf_file_name = 'urdf/robot_assembly.urdf.xacro'  # Adjusted URDF file name

    urdf = os.path.join(
        get_package_share_directory('robot_assembly'),
        urdf_file_name)
    ...
    world_file_name = 'field.world'  # Adjust this to your world file name
